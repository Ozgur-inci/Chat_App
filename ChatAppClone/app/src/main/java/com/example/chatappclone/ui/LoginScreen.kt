    ...
    Box(Modifier.fillMaxSize()) {
        Column(modifier= Modifier
            ...
            Image(painter = painterResource(id = R.drawable.chat), contentDescription =null, modifier = Modifier
                ...
                .padding(top = 16.dp)
                .padding(8.dp))
            Text(text = "Login", modifier = Modifier.padding(8.dp), fontSize = 30.sp, fontFamily = FontFamily.SansSerif)
            ...
            Button(onClick = {
                ...
                vm.onLogin(emailState.value.text,
            ...
            Text(text = "New here? go to SignUp ->",
                ...
                modifier = Modifier
                    ...
                    .clickable {
                        ...
                        // tıklandığında gidilecek yer navigateTo
